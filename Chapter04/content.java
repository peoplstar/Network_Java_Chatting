...
/*
문자 입출력 스트림 필요한 이유 : 자바는 문자를 두바이트 유니코드로 사용하는데,
문자에 대한 인코딩 방식을 변형하여 하는데 DataInput, Output은 불가능
...
bufferedwriter & reader class : 문자 스트림 사이에 버퍼를 추가해 입출력 속도 증가
...
In, OutputStreamWriter : MS-949 인코딩 등 명시적으로 변환 가능, 한글(KSC5601)
